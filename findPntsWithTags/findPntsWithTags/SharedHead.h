...
//26.928 11 8
//37.2 11 5
#define SQUARE_SIZE 30			//<棋盘格方格尺寸
#define WIDTH_CORNER_COUNT 14		//<长边角点个数
#define HEIGHT_CORNER_COUNT 11		//<短边角点个数
...
public:
    ...
    void ErasePoint(unsigned int frameNum, unsigned int pointNum)//删掉frameNum中的第pointNum个点（0为第一个点）
    {
...
#define ThreshLevel 60	//圆提取阈值
#define AreaMax 10000		//轮廓筛选面积最大值
#define AreaMin 20			//轮廓筛选面积最小值
#define RATE    4			//大小圆长轴比例
#define LRATE    4         //椭圆长短轴比，进行标靶标定时LRATE应选大值推荐4，进行正常的识别时选小值，推荐2~2.2
